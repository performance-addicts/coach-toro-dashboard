      ...
      <section {...getCollapseProps()}>
        ...
        <Table>
          <TableBody>
            ...
            <TR>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[TTFB]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[FCP]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[LCP]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[SI]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[TTI]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.KPI.CRT[TBT]} />
              </SH>
            </TR>
            <TR>
              <SH colSpan="4">
        ...
        <Table>
          <TableBody>
            ...
            <TR>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[HTML]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[CSS]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[FONTS]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[JS]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[IMAGES]} />
              </SH>
              <SH colSpan="4">
                <LineChart data={data.BGT.CRT[VIDEOS]} />
              </SH>
            </TR>
            <TR>
              <SH colSpan="4">
